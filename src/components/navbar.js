...
// "Travel" officially removed from the array
    ...
    return (
        <nav 
            ...
            style={{ 
                ...
                position: 'fixed',    // <-- Hard locks it to the viewport window
                top: 0,               // <-- Snaps it to the absolute top edge
                left: 0,              // <-- Snaps it to the left edge
                width: '100%',        // <-- Forces it across full screen width
                zIndex: 9999,         // <-- High layer stack index so it stays above body items
                height: '80px',       // <-- Standard comfortable height frame
                display: 'flex',
                alignItems: 'center'
            }}
        >
